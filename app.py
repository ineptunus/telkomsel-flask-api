...
model_sentiment = load_model("model_sentiment_cnn_lstm_fasttext.h5", compile=False)
model_hate      = load_model("model_hate_speech_cnn_lstm_fasttext.h5", compile=False)
model_sarcasm   = load_model("model_sarcasm_cnn_lstm_fasttext.h5", compile=False)
